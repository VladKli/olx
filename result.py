...
def scrape(url):
    ...
    context = {'title': title, 'price': price, 'description': description, 'imgs': get_pngs(url),
               'data': data, 'extra_info': extra_info}
    print('Создаю файл...')
...
def create_pdf():
    ...
    output = PdfWriter()
    pdfOne = PdfReader(open("/home/andersen/Documents/projects/shar/pdfs/test.pdf", "rb"))
    ...
    for page in pdfOne.pages:
        ...
        count += 1
    outputStream = open(r"result_test_html.pdf", "wb")
